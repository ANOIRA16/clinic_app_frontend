  ...
  Widget _renderColumnView(
    ...
    return Expanded(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: InitialStyle.background,),
        ...
        children: <Widget>[
          SizedBox(
            ...
            child: CupertinoButton(
              pressedOpacity: 0.3,
              padding: EdgeInsetsDirectional.only(start: InitialDims.space4, top: 0),
              child: FxText(
                cancel,
                tag: Tag.h4,
          ...
          SizedBox(
            ...
            child: CupertinoButton(
              pressedOpacity: 0.3,
              padding: EdgeInsetsDirectional.only(end: InitialDims.space4, top: 0),
              child: FxText(
                done,
                tag: Tag.h4,
                color: InitialStyle.secondaryTextColor,
